...
include_once($GLOBALS['xoops']->path('/class/xoopsform/formtextarea.php'));
include_once($GLOBALS['xoops']->path('/modules/psychtest/include/formpsychblotter.php'));
include_once($GLOBALS['xoops']->path('/modules/psychtest/include/functions.php'));
 ...
 * @subpackage form
 */
class XoopsFormPsychTest extends XoopsFormElement {
	/**
	 ...
	 */
	function XoopsFormPsychTest( $caption, $delimeter = "&nbsp;", $name = "" ) {
		$this->setName( $name );
		...
		$this->addElement(new XoopsFormPsychBlotter('', 'blotter_name'));
		$this->addElement(new XoopsFormHidden('blotter_base64', xoops_convert_encode(psychtest_blotter($xoConfig['width'], $xoConfig['height'], $GLOBALS['passkey']),'base64')));
		$this->addElement(new XoopsFormTextArea('', 'blotter_response', 30, 40));
	}
